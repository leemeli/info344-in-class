...
func Reverse(s string) string {
	...
	chars := []rune(s) //covert into a slice of runes, which are complete Unicode characters
...
func (ld *LateDays) Consume(netID string) int {
	...
	if _, found := ld.entries[netID]; !found { // in a map, you can get a second value "found" which is a boolean which sees if it exists
